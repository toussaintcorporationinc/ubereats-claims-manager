...
def route_uber_reporting_file(
    ...
    set_processing_metadata(
        ...
        payments_applied_count=confirm_result["payments_applied_count"],
        payments_unmatched_count=confirm_result["payments_unmatched_count"],
        payment_conflicts_count=confirm_result["payment_conflicts_count"],
...
def result_payload(preview_file: SmartImportPreviewFile, action: str) -> dict[str, Any]:
    ...
    return {
        ...
        "payments_applied_count": metadata.get("payments_applied_count"),
        "payments_unmatched_count": metadata.get("payments_unmatched_count"),
        "payment_conflicts_count": metadata.get("payment_conflicts_count"),
