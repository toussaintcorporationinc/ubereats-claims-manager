    ...
    def analyze_gmail_message(
        ...
        *,
        ...
        prompt = (
            ...
            "Si Gmail contient STARRED, cela indique seulement un dossier urgent, pas une preuve de refus. "
            "Lis la reponse actuelle avant de choisir entre refus, demande de justificatifs, demande "
            "d'informations, decision en attente ou paiement annonce. "
            "Un avis indiquant qu'une conversation est fermee et que le message n'a pas ete recu "
            "doit etre classe manual_review : ce n'est pas un refus de remboursement. "
            "Une reponse Gmail positive, meme avec un montant, reste payment_to_verify tant que le credit officiel "
            "n'est pas rapproche dans le reporting Uber. N'utilise jamais payment_confirmed depuis le seul email. "
