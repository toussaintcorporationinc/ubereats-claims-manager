...
def replace_check_constraint(table_name: str, constraint_name: str, check_clause: str) -> None:
    op.drop_constraint(constraint_name, table_name, type_="check")
    op.create_check_constraint(constraint_name, table_name, check_clause)
...
def upgrade() -> None:
    if is_sqlite():
        ...
        replace_check_constraint("evidence_files", "ck_evidence_files_type", NEW_EVIDENCE_CHECK)
        replace_check_constraint("email_drafts", "ck_email_drafts_type", NEW_EMAIL_DRAFT_TYPE_CHECK)
    ...
    if is_sqlite():
        ...
        op.drop_constraint("ck_evidence_request_tasks_required_type", "evidence_request_tasks", type_="check")
        op.add_column("evidence_request_tasks", sa.Column("customer_refund_dispute_id", sa.Integer(), nullable=True))
        ...
        op.create_check_constraint(
            "ck_evidence_request_tasks_required_type",
            "evidence_request_tasks",
            NEW_REQUIRED_EVIDENCE_CHECK,
        )
    op.create_index(
...
def downgrade() -> None:
    ...
    if is_sqlite():
        ...
        op.drop_constraint("fk_evidence_request_tasks_customer_refund_dispute_id", "evidence_request_tasks", type_="foreignkey")
        op.drop_constraint("ck_evidence_request_tasks_required_type", "evidence_request_tasks", type_="check")
        op.drop_column("evidence_request_tasks", "customer_refund_dispute_id")
        op.create_check_constraint(
            "ck_evidence_request_tasks_required_type",
            "evidence_request_tasks",
            OLD_REQUIRED_EVIDENCE_CHECK,
        )
    ...
    if is_sqlite():
        ...
        replace_check_constraint("email_drafts", "ck_email_drafts_type", OLD_EMAIL_DRAFT_TYPE_CHECK)
    ...
    if is_sqlite():
        ...
        replace_check_constraint("evidence_files", "ck_evidence_files_type", OLD_EVIDENCE_CHECK)
